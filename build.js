...
const { BuildProcessor } = require('./build.config.js');

class GlucoBalanceBuildScript {
    constructor() {
        this.buildProcessor = new BuildProcessor(require('./build.config.js').BuildConfig);
...
module.exports = GlucoBalanceBuildScript;